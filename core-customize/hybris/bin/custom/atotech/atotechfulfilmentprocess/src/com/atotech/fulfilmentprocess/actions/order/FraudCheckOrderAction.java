 ...
 */
package com.atotech.fulfilmentprocess.actions.order;
...
import com.atotech.fulfilmentprocess.constants.AtotechFulfilmentProcessConstants;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(AtotechFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(AtotechFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
