 ...
 */
package com.atotech.core.constants;

/**
 * Global class for all AtotechCore constants. You can add global constants for your extension into this class.
 */
public final class AtotechCoreConstants extends GeneratedAtotechCoreConstants
{
	public static final String EXTENSIONNAME = "atotechcore";


	private AtotechCoreConstants()
	{
		//empty
	}
